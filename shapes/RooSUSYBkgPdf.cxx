 ...
 { 
   ...
   return TMath::Power(inv,a1)*TMath::Exp(-b1*inv-b2*TMath::Power(inv,2));//+TMath::Power(inv,a2)*TMath::Exp(-b2*inv); 
   //~ return TMath::Power(TMath::Log(inv),a1)*TMath::Exp(-b1*TMath::Log(inv)); slighly better
